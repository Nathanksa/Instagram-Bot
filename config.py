...
class Config:
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "5495733636:AAG-hWCyTW8BflO50q7HNfcIidy2nOwND8U") 
    USER = os.environ.get("INSTAGRAM_USERNAME", "tempeasf")
    OWNER = os.environ.get("OWNER_ID", "1168988735")
